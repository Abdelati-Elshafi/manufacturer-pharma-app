...
class _CancelShipmentPageWidgetState extends State<CancelShipmentPageWidget> {
  ...
  void initState() {
    ...
    _model.testtttTextController ??= TextEditingController();
    _model.testtttFocusNode ??= FocusNode();
  }
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .testtttTextController,
                                                focusNode:
                                                    _model.testtttFocusNode,
                                                onChanged: (_) =>
                                                    EasyDebounce.debounce(
                                                  '_model.testtttTextController',
                                                ...
                                                enableInteractiveSelection:
                                                    true,
                                                validator: _model
                                                    .testtttTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ],
                  ...
                  Padding(
                    ...
                    child: Container(
                      child: FFButtonWidget(
                        onPressed: () async {
                          safeSetState(() {
                            _model.testtttTextController?.text = 'bvdgdfgdfg';
                          });
                        },
